...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // Chama o método SaveChanges do _context para salvar no Banco SQL
        ...
        // Chama o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // Chama o método de Update do _context.Funcionarios para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // Chama o método de Remove do _context.Funcionarios para salvar no Banco SQL
